...
export default class Dashboard extends Component {
  ...
  getProduct = () => {
    ...
    axios.get(`https://gst-sever.onrender.com/get-product${data}`, {
      headers: {
  ...
  deleteProduct = (id) => {
    axios.post('https://gst-sever.onrender.com/delete-product', {
      id: id
    }, {
      headers: {
  ...
  addProduct = () => {
    ...
    axios.post('https://gst-sever.onrender.com/add-product', file, {
      headers: {
  ...
  updateProduct = () => {
    ...
    axios.post('https://gst-sever.onrender.com/update-product', file, {
      headers: {
        'content-type': 'multipart/form-data',
        'token': this.state.token
      }
            ...
            <Table aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="center">GST/CGST</TableCell>
                  <TableCell align="center">Total Payable Amount</TableCell>
                ...
                {this.state.products.map((row) => (
                  <TableRow key={row.name}>
                    ...
                    <TableCell align="center">
                      <img
                        src={`https://gst-sever.onrender.com/${row.image}`}
                        width="70"
                        height="70"
                        alt=''
                      />
